...
// Level Devil is keyboard-first (arrows/WASD + space to play, mouse+keyboard
...
(function () {
  ...
  overlay.innerHTML =
    '<div class="mobile-guard-box">' +
      ...
      '<p>Level Devil se joue et se construit au clavier (flèches, espace…) : ça ne fonctionne pas sur mobile ou tablette.</p>' +
